...
class QuestionnairesControllerTest < ActionController::TestCase
  ...
  test "should create questionnaire" do
    assert_difference('Questionnaire.count') do
      post :create, questionnaire: { finished: @questionnaire.finished, host_id: @questionnaire.host_id, subject_id: @questionnaire.subject_id }
    end
  ...
  test "should update questionnaire" do
    patch :update, id: @questionnaire, questionnaire: { finished: @questionnaire.finished, host_id: @questionnaire.host_id, subject_id: @questionnaire.subject_id }
    assert_redirected_to questionnaire_path(assigns(:questionnaire))
  end

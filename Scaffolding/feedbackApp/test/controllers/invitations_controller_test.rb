...
class InvitationsControllerTest < ActionController::TestCase
  ...
  test "should create invitation" do
    assert_difference('Invitation.count') do
      post :create, invitation: { accepted: @invitation.accepted, email: @invitation.email, user_id: @invitation.user_id }
    end
  ...
  test "should update invitation" do
    patch :update, id: @invitation, invitation: { accepted: @invitation.accepted, email: @invitation.email, user_id: @invitation.user_id }
    assert_redirected_to invitation_path(assigns(:invitation))
  end
